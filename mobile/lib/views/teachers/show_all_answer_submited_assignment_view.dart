...
class AllAnswerAssignmentSubmitedView extends StatefulWidget {
  final int assignmentId;
  const AllAnswerAssignmentSubmitedView({super.key, required this.assignmentId});

  @override
  State<AllAnswerAssignmentSubmitedView> createState() => _AllAnswerAssignmentSubmitedViewState();
}

class _AllAnswerAssignmentSubmitedViewState extends State<AllAnswerAssignmentSubmitedView> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      _progressViewModel.readAllAnswerAssignmentSubmited(widget.assignmentId);
    });
    super.initState();
  }
        ...
        case LoadingStatus.complete:
          return RefreshIndicator(
            ...
            child: ListView.builder(
                itemCount: _progressViewModel.allAnswerAssignmentModel.value.allAnswerAssignment.allAnswer.length,
                itemBuilder: (context, index) {
                  var data = _progressViewModel.allAnswerAssignmentModel.value.allAnswerAssignment.allAnswer[index];
                  return ListTile(
                                                  ...
                                                  child: CommonBtn(
                                                    ...
                                                    callback: () {
                                                      if (_scoreCtrl.text.isEmpty) {
                                                        ...
                                                        _roomView.addScoreAssignment(data.id, _scoreCtrl.text);
                                                    ...
                                                    isLoading: _roomView.addScoreLoadingAssignment.value,
                                                  ),
                                                ))
                                          ],
                                        ),
