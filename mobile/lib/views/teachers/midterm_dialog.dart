...
class MidtermDialog extends StatefulWidget {
  final int subjectId;
  const MidtermDialog({super.key, required this.subjectId});

  @override
  State<MidtermDialog> createState() => _MidtermDialogState();
}

class _MidtermDialogState extends State<MidtermDialog> {
                  ...
                  child: CommonBtn(
                      ...
                      callback: () {
                        if (_txtCtrl.text.isEmpty) {
                          ...
                          _roomViewModel.createMidterm(_classId, _txtCtrl.text,
                              widget.subjectId.toString());
                          _roomViewModel.readMidterm(widget.subjectId);
                        }
                      },
                      isLoading: _roomViewModel.createMidtermLoading.value),
                );
              })
            ],
          ),
