...
class FinalExamView extends StatefulWidget {
  final int classId;
  const FinalExamView({super.key, required this.classId});

  @override
  State<FinalExamView> createState() => _FinalExamViewState();
}

class _FinalExamViewState extends State<FinalExamView> {
  @override
